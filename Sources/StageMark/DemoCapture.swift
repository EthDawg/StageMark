...
final class DemoCapture: NSObject, ObservableObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    @Published private(set) var message = "Connect and unlock your device, then choose its screen."
    ...
    private func connect(_ id: String) {
        ...
        case .denied, .restricted:
            publish("Device video access is off. Enable StageMark in System Settings → Privacy & Security → Camera, then choose Reconnect.")
            return
        default: break
        }
