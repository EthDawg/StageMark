...
**Choose a starter** opens eight offline backdrops: Office & professional, Care & service and six Australian sector settings. Selecting one makes a new saved scene; the gallery never fills or resets your customer list. **Add customer logo** keeps the logo separate with four corner positions, a size slider and optional light or dark backing. Replace it to reuse a scene for another customer, or duplicate the scene to keep both. The logo is included in PNG export and desktop apply.
